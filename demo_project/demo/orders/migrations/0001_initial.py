# Generated by Django 2.2.6 on 2019-11-09 08:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=200)),
                ('status', models.CharField(choices=[('In Current Sprint', 'In Current Sprint'), ('Not in Current Sprint', 'Not in Current Sprint')], default='Not in Current Sprint', max_length=20)),
                ('description', models.CharField(max_length=2000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='orders.DevTeamMember')),
            ],
        ),
        migrations.CreateModel(
            name='ProductOwner',
