    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teamID', models.CharField(default='A', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('sprintView', models.CharField(default='A', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hourSpent', models.IntegerField(blank=True, default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('pbi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orders.Pbi')),
                ('sprint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orders.Sprint')),
